        ...
        books = [
            {
                ...
                "synopsis": "아기돼지 삼형제는 세 마리의 아기돼지가 늑대를 피해 집을 짓는 이야기입니다. 첫째 돼지는 빨리 집을 짓기 위해 짚으로 집을 짓고, 둘째 돼지는 나무로 집을 짓습니다. 그러나 늑대가 나타나 이 두 집을 쉽게 무너뜨리자, 셋째 돼지는 벽돌로 튼튼한 집을 짓습니다. 결국, 늑대는 셋째 돼지의 집을 무너뜨리지 못하고 돼지 삼형제는 안전하게 지내게 됩니다."
            },
            {
                "title": "백설공주",
